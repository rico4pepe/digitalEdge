...
$TransactionReference = $_GET['TransactionReference'] ?? '12345';
$currencyId = $_GET['currencyId'] ?? null;
$currencyCode = $_GET['currencyCode'] ?? null;

$requestData = [
    'TransactionReference' => $TransactionReference, // Add merchantCode to the data array
...
try {
    ...
    $response = $apiClient->request('GET', 'api/v1/Product/Voucher/Status/{TransactionReference}', $requestData);
